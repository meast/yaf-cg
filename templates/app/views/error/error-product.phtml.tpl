...
<pre class="strong">
    ...
    <span class="file"><?php $f = $e->getFile();$p = pathinfo($f); echo $p['filename'];?></span> at line <span class="line"><?php echo $e->getLine()?></span>
</pre>

<div id="traces">
    <h2>Exception Trace</h2>
    <pre><code><?php echo strtr($e->getTraceAsString(), array(PATH_APP => ''))?></code></pre>
